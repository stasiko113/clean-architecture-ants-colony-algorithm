...
export class EdgeMapperProfile implements MapperProfileInterface<EdgeModel, EdgeEntity> {
	...
	toModel(entityOrEntities: EdgeEntity | EdgeEntity[]): EdgeModel | EdgeModel[] {
